...
poly.setMap(map);$.each(data,function(i,val){bounds.extend(new google.maps.LatLng(val.y,val.x));new SearchMarker({latlng:new google.maps.LatLng(val.y,val.x),map:map,paInformation:val});var poly=createGeoJsonPolygon(val.the_geom)
