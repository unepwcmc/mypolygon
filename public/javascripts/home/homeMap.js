...
var ppeOverlay;
var coralMapType;
var coralOverlayOptions;
var coralOverlayPosition = 1;
var CORAL_TILE_SERVER = 'http://downloads.wdpa.org/ArcGIS/rest/services/ocean_data_viewer/coralreefs2010/MapServer/tile/';
var mangroveMapType;
var mangroveOverlayOptions;
var mangroveOverlayPosition = 2;
var MANGROVE_TILE_SERVER = 'http://downloads.wdpa.org/ArcGIS/rest/services/ocean_data_viewer/mangroves2/MapServer/tile/';
var current_latlng;
...
function initialize() {
  ...
  //set overlay placeholders
  map.overlayMapTypes.insertAt(coralOverlayPosition, coralMapType);
  map.overlayMapTypes.insertAt(mangroveOverlayPosition, coralMapType);

  //Initialise the overlays
  //coral TileOverlay
  coralOverlayOptions = {
    getTileUrl: function(coord, zoom) {
      return CORAL_TILE_SERVER + zoom + "/"+ coord.y + "/" + coord.x;
    },
    tileSize: new google.maps.Size(256, 256),
    isPng: true
  };
  coralMapType = new google.maps.ImageMapType(coralOverlayOptions);

  //mangrove TileOverlay
  mangroveOverlayOptions = {
    getTileUrl: function(coord, zoom) {
      return MANGROVE_TILE_SERVER + zoom + "/"+ coord.y + "/" + coord.x;
    },
    tileSize: new google.maps.Size(256, 256),
    isPng: true
  };
  mangroveMapType = new google.maps.ImageMapType(mangroveOverlayOptions);
